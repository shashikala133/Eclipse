...
public class BitStuffingServer {
	public static void main(String[] args) throws IOException
	{
		...
		// Receiving the string from the client which needs to be stuffed
		...
		for (int i = 8; i < s.length() - 8; i++) {
			...
			if (ch == '1') {
				cnt++;
				System.out.print(ch);
				// After 5 consecutive 1's one stuffed bit '0' is added. 
//We need to remove that.
				...
				System.out.print(ch);
				// we only need to maintain count of consecutive 1's
				cnt = 0;
			}
		}//end of for
		System.out.println();
